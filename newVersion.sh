...
blacklist=(3.0.0-alpha.1 3.0.0-alpha.2 3.0.0-alpha.3 3.0.0-alpha.4 3.0.0-alpha.5 3.0.0-alpha.6 3.0.0-alpha.7
...
NEWLINE/g' README.md
  ...
  npx @vue/cli@${version} create ponyracer  -m npm --inlinePreset '{"useConfigFiles": true,"plugins": {"@vue/cli-plugin-typescript": {"classComponent": false},"@vue/cli-plugin-eslint": {"config": "prettier","lintOn": ["save"]},"@vue/cli-plugin-unit-jest": {},"@vue/cli-plugin-e2e-cypress": {}}}'
